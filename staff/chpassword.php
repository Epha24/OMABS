...
if($_SESSION['role'] != 'staff'){
   ...
   $qry = "SELECT *FROM user WHERE password = '$oldpassword' AND username = '".$_SESSION['username']."'";
   ...
   if(strlen($newpassword) > 6){
    $enc = md5($newpassword);
   $insert_query = "UPDATE user SET password = '$enc' WHERE password = '$oldpassword'";
            ...
            <div class="card">
              <div class="card-header">
                ...
                <form role="form" action="chpassword.php" method="POST">
                  ...
                  <button type="submit" name="change" class="btn btn-primary mn">Submit</button>
                </div>
                </form>
          </div>
      </div><!-- /.container-fluid -->
