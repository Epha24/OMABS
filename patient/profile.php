...
if(isset($_POST['register'])){
  ...
  if(empty($_POST['gender']) || empty($_POST['mstatus'])){
      $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='border-radius:0px;'>
             ...
             $mstatus = mysqli_escape_string($conn,$_POST['mstatus']);
             $phone = mysqli_escape_string($conn,$_POST['phone']);
             $address = mysqli_escape_string($conn,$_POST['address']);


              $qry_insert = "INSERT INTO patient(fname, mname, lname, age, gender, mstatus,phone,email,address) VALUES('$fname', '$mname','$lname','$age','$gender','$mstatus','$phone','$email','$address')";
              ...
              if($ext){
                ...
                $msg = "<div class='alert alert-danger alert-dismissible fade show' role='alert' style='border-radius:0px;'>
                  <strong><center>Not Registered !!!</center></strong>
                       <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                       <span aria-hidden='true'>&times;</span>
                 </button></div>";
              }
...
if(isset($_POST['update-detail'])){
  ...
  $update = "UPDATE patient SET fname = '$fname', mname = '$mname', lname = '$lname', address = '$address', phone = '$phone' WHERE email = '$email'";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index.php" class="brand-link" title="Online Medical Appointment Booking Systemy">
      ...
      <div class="container-fluid">
        ...
        <div class="card-header">
            ...
            <div class="card-body">
              <?php 
                    $id = "";
                    $qry_select = "SELECT *FROM patient WHERE email = '".$_SESSION['username']."'";
          ...
          <div class="form-row">
                ...
                <div class="form-row">                  
                  ...
                  <div class="form-group col-sm-6" id="email">
                    <input type="hidden" class="form-control" name="email" placeholder="Enter Email" value="<?php echo $_GET['update-detail'];?>" required>
                  </div>
                </div>
        </div>
        <div class="card-footer">
